...
<div class="col-md-12">
	@component('component.white-box', ['title' => trans('common.titles.option_groups')])
		@slot('buttons')
            @component('component.modal', ['id' => 'filter', 'class' => 'btn btn-sm btn-secondary ml-2'])
                ...
                <div id="filters">
                    <form action="{{ route('admin.option-groups.index') }}" method="get">
                        <div class="row">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select name="active" id="active" class="form-control input-sm">
                                        <option value=""></option>
                                        @foreach(\App\Domain\OptionGroups\Models\OptionGroup::statuses() as $active)
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control input-sm" name="type" id="type" type="text"  value="{{ $filters['type'] ?? '' }}"/>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <div class="float-riht">
                                    <a href="{{ route('admin.option-groups.index') }}" class="btn btn-sm btn-danger">@lang('admin.filters_reset')</a>
            ...
            @endcomponent
		<a href="{{ route('admin.option-groups.create') }}" class="btn btn-sm btn-primary ml-2">
                    ...
                    <tbody>
                    	@foreach($optionGroups as $item)
                    		<tr>
                                <td>{{ $item->id }}</td>
                                <td>
                                    <a href="{{ route('admin.option-groups.edit', $item) }}" data-toggle="tooltip" data-placement="top" data-original-title="@lang('admin.edit')">
                                        {{ $item->title }}
                                    </a>
                                </td>
                                <td>{{ $item->type }}</td>
                                ...
                                <td class="text-nowrap">
                                    <a href="{{ route('admin.option-groups.edit', $item) }}" data-toggle="tooltip" data-placement="top" data-original-title="@lang('admin.edit')"> <i class="fa fa-pencil text-inverse m-r-10"></i> </a>
                                    {{-- <a href="#" data-toggle="tooltip" data-original-title="@lang('admin.delete')"> <i class="fa fa-close text-danger"></i> </a> --}}
                                    <form action="{{ route('admin.option-groups.destroy', $item) }}" class="dib" method="post">
                                        @csrf
                                        @method('delete')
        ...
        @slot('bottom')
    		@include('common.pagination', ['data' => $optionGroups])
		@endslot
