...
@section('center_content')
    ...
    <div class="shap_big_2 d-none d-lg-block">
        <img src="{{asset('images/ilstrator/body_shap_2.png')}}" alt="">
    </div>
    <!-- slider_area_start -->
    <div class="slider_area">
        <div class="shap_img_1 d-none d-lg-block">
            <img src="{{ asset('images/ilstrator/body_shap_1.png') }}" alt="">
        </div>
        <div class="poly_img">
            <img src="{{ asset('images/ilstrator/poly.png') }}" alt="">
        </div>
                    ...
                    <div class="col-xl-10 offset-xl-1">
                        <div class="slider_text text-center">
                            ...
                            <div class="ilstrator_thumb">
                                <img src="{{ asset('images/ilstrator/illustration.png') }}" alt="">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-5 col-md-5">
                    <div class="man_thumb">
                        <img src="{{ asset('images/ilstrator/man.png') }}" alt="">
                    </div>
                </div>
    ...
    <div class="case_study_area case_bg_1">
        ...
        <div class="patrn_2 d-none d-lg-block">
            <img src="{{ asset('images/pattern/patrn.png') }}" alt="">
        </div>
        <div class="container">
            <div class="row">
                <div class="col-xl-12">
                ...
                <div class="col-xl-12">
                    <div class="case_active owl-carousel">
                        <div class="single_study text-center">
                            <div class="thumb">
                                <a href="#">
                                    <img src="{{ asset('images/case_study/1.png') }}" alt="">
                                </a>
                            </div>
                        ...
                        <div class="single_study text-center">
                            <div class="thumb">
                                <a href="#">
                                    <img src="{{ asset('images/case_study/2.png') }}" alt="">
                                </a>
                            </div>
                            <div class="subheading">
                        ...
                        <div class="single_study text-center">
                            <div class="thumb">
                                <a href="#">
                                    <img src="{{ asset('images/case_study/3.png') }}" alt="">
                                </a>
                            </div>
                            <div class="subheading">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-xl-6 col-lg-6">
                    <div class="accordion_thumb">
                        <img src="{{ asset('images/banner/accordion.png') }}" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-xl-4 col-md-6 col-lg-4">
                    <div class="single_feature">
                        <div class="icon">
                            <img src="{{ asset('images/svg_icon/feature_1.svg') }}" alt="">
                        </div>
                        <h4>Custom design</h4>
                ...
                <div class="col-xl-4 col-md-6 col-lg-4">
                    <div class="single_feature">
                        <div class="icon">
                            <img src="{{ asset('images/svg_icon/feature_2.svg') }}" alt="">
                        </div>
                ...
                <div class="col-xl-4 col-md-6 col-lg-4">
                    <div class="single_feature">
                        <div class="icon">
                            <img src="{{ asset('images/svg_icon/feature_3.svg') }}" alt="">
                        </div>
                ...
                <div class="col-xl-4 col-md-6 col-lg-4">
                    <div class="single_feature">
                        <div class="icon">
                            <img src="{{ asset('images/svg_icon/feature_4.svg') }}" alt="">
                        </div>
                ...
                <div class="col-xl-4 col-md-6 col-lg-4">
                    <div class="single_feature">
                        <div class="icon">
                            <img src="{{ asset('images/svg_icon/feature_5.svg') }}" alt="">
                        </div>
                ...
                <div class="col-xl-4 col-md-6 col-lg-4">
                    <div class="single_feature">
                        <div class="icon">
                            <img src="{{ asset('images/svg_icon/feature_6.svg') }}" alt="">
                        </div>
                    ...
                    <div class="testmonial_active owl-carousel">
                        <div class="single_carousel">
                            <div class="single_testmonial text-center">
                                <div class="quote">
                                    <img src="{{ asset('images/testmonial/quote.svg') }}" alt="">
                                </div>
                                ...
                                <div class="testmonial_author">
                                    <div class="thumb">
                                        <img src="{{ asset('images/testmonial/thumb.png') }}" alt="">
                                    </div>
